...
1. **Baseline:** Run execute a script that computes a slope/correlation or equivalent comparison and prints an interpretation paragraph before editing. If it fails, narrate the failure honestly and recover before adding new code.
