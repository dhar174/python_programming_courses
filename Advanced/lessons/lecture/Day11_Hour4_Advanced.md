...
1. **Baseline:** Run one command that creates or refreshes all report artifacts from current data before editing. If it fails, narrate the failure honestly and recover before adding new code.
