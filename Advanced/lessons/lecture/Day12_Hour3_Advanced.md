...
1. **Baseline:** Run follow README setup from a clean terminal and start the chosen app surface before editing. If it fails, narrate the failure honestly and recover before adding new code.
