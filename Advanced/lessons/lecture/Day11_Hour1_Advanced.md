...
1. **Baseline:** Execute the report script and inspect `head`, `dtypes`, row counts, and the generated summary file before editing. If it fails, narrate the failure honestly and recover before adding new code.
