...
1. **Baseline:** POST payloads that include valid values, missing fields, extra fields, and incorrect types before editing. If it fails, narrate the failure honestly and recover before adding new code.
