...
These JSON files are **generated by learners when they export their answers from the quiz HTML page**. They are submission artifacts, not required source files for quiz authoring, and may not be committed to the repository.
