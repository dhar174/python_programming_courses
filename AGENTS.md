...
The content is primarily delivered as slides (generated with Marp; for PPTX-first or editable deck work, `.github/skills/slides` is also available as an alternative or supplement), lecture scripts and notes, homework assignments as ipynb notebooks, and multiple choice questions. The course is aligned to the Python Institute certification pathway (PCEP and PCAP).
...
4. **Local testing**:
   ...
   jupyter nbconvert --to script submissions/<your_Basics_Day1_notebook>.ipynb --output basics_day1.py  # e.g., submissions/alex_Basics_Day1_homework.ipynb
